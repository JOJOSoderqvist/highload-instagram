...
Всего на 1 ДЦ приходится 87 080 CPU и 8728 ГБ RAM. Исходя из этих расчетов выберем конфигурацию серверов.

| Сервис   | Конфиг                                                                         | Ядра | Количество на 1 ДЦ | Цена за 1 шт | Аренда на месяц               |
| -------- | ------------------------------------------------------------------------------ | ---- | ------------------ | ------------ | ----------------------------- |
