...
Рассмотрим бенчмарк для выбранного языка программирования Go[^19], исходя из которого можем взять средний RPS в 100К.
...
|-------------|-----------|---------------|--------|-----------|------------|
| post        | 2 400     | средняя       | 48     | 4800      | 10 Гбит/c  |
| feed        | 1 700 000 | средняя       | 85 000 | 8 500 000 | 6.8 Тбит/c |
| impressions | 15 000    | простая       | 150    | 15 000    | 1 Мбит/c   |
| profile     | 10 000    | средняя       | 200    | 40 000    | 100 Мбит/c |
| auth        | 200       | простая       | 2      | 200       | 40 Кбит/c  |
| follow      | 2 000     | простая       | 20     | 2000      | 320 Кбит/c |
| comments    | 164 000   | простая       | 1640   | 164 000   | 1.2 Гбит/c |
| saved posts | 2 000     | простая       | 20     | 2000      | 320 Кбит/c |

### Выбор серверного оборудования

Всего на все ДЦ приходится 87 080 CPU и 8728 ГБ RAM. Исходя из этих расчетов выберем конфигурацию серверов.

| Сервис   | Конфиг                                                                         | Ядра | Количество на все ДЦ | Цена за 1 шт | Аренда на месяц               |
|----------|--------------------------------------------------------------------------------|------|----------------------|--------------|-------------------------------|
| KubeNode | 1U 15 x Intel Xeon Gold 6448Y 32 Cores/16x 16GB RAM/ 2x NVME 2T / 2x 25 Gbit/s | 480  | 182                  | 40 000$      | 666$ в месяц, 40000$ на 5 лет |
