...
Расположение датацентров выбиралось исходя из [распределения аудитории по странам](#распределение-аудитории-по-странам), наземной сетевой инфраструктуры[^15], а также карты оптоволоконных кабелей. ![Карта оптоволоконных кабелей](diagrams/submarine-cable-map.png)
